    ...
    with SSHTunnelForwarder(
        ...
        try:
            with connection.cursor() as cursor:
                ...
                print(str(datetime_start_date), str(datetime_end_date))
                if len(result) == 0:
                    return []
                ...
                dfx.rename(columns={"index":"datetime"}, inplace=True)
                dfx['datetime'] = dfx['datetime'].dt.strftime('%Y-%m-%d %H:%M:%S')
...
# print(db_read('dl-atm41_5245', last='5d'))
